...
for (root, dirs, files) in os.walk("./data/car-dataset-200", topdown=True):
...
with open("./data/json/dataset.json", "w") as f:
    json.dump(result, f, indent = 4)

print(f"Succesfully added {counter} objects to dataset.json")
